...
**`150-plan-mode-consistency`**

```
.xdrs/agentme/edrs/principles/skills/
  150-plan-mode-consistency/SKILL.md
```
...
- [150-plan-mode-consistency](../../../../../agentme/edrs/principles/skills/150-plan-mode-consistency/SKILL.md)
