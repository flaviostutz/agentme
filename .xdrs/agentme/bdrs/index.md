...
- [analyse-cvs](operations/skills/analyse-cvs/SKILL.md) - **Analyse CVs** — Scores and ranks candidate CVs in a `.tmp/` folder against agreed weighted criteria for a role, organising the documents into one folder per candidate, with redaction and a top-3 interview brief *(skill)*
