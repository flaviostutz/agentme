...
- [agentme-edr-128](application/128-browser-automation-foundation.md) - **Browser automation foundation** - Single foundation skill opens every browser; connectors pass their own CDP port and attach to it *(includes skill: [open-browser-playwright](application/skills/open-browser-playwright/SKILL.md))*
