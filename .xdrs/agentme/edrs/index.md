...
- [agentme-edr-003](principles/003-hitl-question-content.md) - **HITL question content** - What every agent question to a human must contain: location, finding, why it is a doubt, options with consequences, and a recommendation
