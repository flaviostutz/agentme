...
- [agentme-edr-003](principles/003-hitl-question-content.md) - **HITL question content** - Compact template for every agent question to a human: short title with context, 2-4 options with consequences, a "(recommended)" prefix, and word caps
