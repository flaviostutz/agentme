...
Every question to the human (including overwrite confirmations) MUST follow [`agentme-edr-003`](../../../principles/003-hitl-question-content.md):
...
Pure information requests (e.g. application names) MAY skip options and the recommendation.
